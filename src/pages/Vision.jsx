    ...
    <div className="flex min-h-screen flex-col items-center justify-start">
      ...
      <div className="mt-20 grid min-w-full grid-cols-2 justify-items-center">
        ...
        <div className="mt-20 grid-cols-1 pr-[18rem] text-red-400 text-opacity-90">
          ...
          <p className="font-mono text-black text-opacity-50">
            {" "}
            Uplimit Data Analyst Fellow
          </p>
          <p className="mt-2 font-mono text-black">
            ◦ Crafted advanced AI and ML applications utilizing Python, with
            proficiency in NumPy, Pandas, and Scikit-learn for enhanced
        ...
        <div className="mt-20 grid-cols-1 pr-[18rem] text-red-400 text-opacity-90">
          ...
          <p className="mt-2 font-mono text-black">
            ...
            backend projects using the PERN stack, encompassing PostgreSQL,
            Express.js, React, Node.js
          </p>
          <p className="mb-2 mt-2 font-mono text-black">
            ◦ Gained proficiency in implementing advanced Data Structures and
